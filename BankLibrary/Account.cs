...
namespace BankLibrary
{
    ...
    {
        protected internal event AccountStateHandler Withdrawed;//при снятии денег
        protected internal event AccountStateHandler Added;//при добавлении денег
        protected internal event AccountStateHandler Opened;//при открытии счета
        protected internal event AccountStateHandler Closed;//при закрытии счета
        protected internal event AccountStateHandler Calculated;//при начислении процентов
